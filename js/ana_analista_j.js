  ...
  function consultaUsuario(correo,nombre,foto){
  	...
  	.done(function(data) {
          ...
          console.log("analista");
					...
					$('ul.ul_sesion').append(`<li><a class='waves-effect btn_cerrarsesion' href='#'>Cerrar Sesion</a></li>`);
      ...
      inserting: false,
        ...
        controller: db,
            ...
            fields: [
            {
            	...
            	name: "fechaIngreso",
            	title: "Fec. Digitación",
            	type: "number",
            	sorting: true,
            	editing: false,
            	width: 150,
            	css: "php csv check_ingresado ingresado_qad"
            }, {
            	name: "QAD",
            	title: "QAD",
            	type: "number",
            	...
            	editing: false,
            	width: 40,
            	css: "qad csv check_ingresado esta_qad"
            }, {
            	name: "CLIENTE",
            	title: "CLIENTE",
            	type: "number",
            ...
            .click(function(e) {
              if(e.target.className =="material-icons subir"){
                ...
                for (var i = posicionActual; i > 0 ; i--) {
                  var recorrer=false;
                  var ph=largo.eq(i-1).children("td").eq(14).text();
                       ...
                       if(ph==""){
                         ...
                         return;
                          ...
                          if(recorrer){
                            ...
                            var locacion = largo.eq(i-1).children("td").eq(3).text()
                            var articulo = largo.eq(i-1).children("td").eq(4).text()
                            var fecha = largo.eq(i-1).children("td").eq(5).text()
                            var lote = largo.eq(i-1).children("td").eq(6).text()
                            var referencia = largo.eq(i-1).children("td").eq(7).text()
                            var estado = largo.eq(i-1).children("td").eq(8).text()
                            var descripcion = largo.eq(i-1).children("td").eq(9).text()
                            var cliente = largo.eq(i-1).children("td").eq(10).text()
                            var nombre = largo.eq(i-1).children("td").eq(11).text()
                            var cantidad = largo.eq(i-1).children("td").eq(12).text()
                            var um = largo.eq(i-1).children("td").eq(13).text()
                            var phs = largo.eq(i-1).children("td").eq(14).text()
                            var brix = largo.eq(i-1).children("td").eq(15).text()
                            var cons5sec = largo.eq(i-1).children("td").eq(16).text()
                            var cons30sec = largo.eq(i-1).children("td").eq(17).text()
                            var acasc = largo.eq(i-1).children("td").eq(18).text()
                            var acidez = largo.eq(i-1).children("td").eq(19).text()
                            var bar = largo.eq(i-1).children("td").eq(20).text()
                            var color = largo.eq(i-1).children("td").eq(21).text()
                            var densidad = largo.eq(i-1).children("td").eq(22).text()
                            var pnegro = largo.eq(i-1).children("td").eq(23).text()
                            var patulina = largo.eq(i-1).children("td").eq(24).text()
                            var ramacidos = largo.eq(i-1).children("td").eq(25).text()
                            var hongos = largo.eq(i-1).children("td").eq(26).text()
                            var levadura = largo.eq(i-1).children("td").eq(27).text()
                            var ecoli = largo.eq(i-1).children("td").eq(28).text()
                            var coliformes = largo.eq(i-1).children("td").eq(29).text()
                            var hongosterm = largo.eq(i-1).children("td").eq(30).text()
                            var salmonela = largo.eq(i-1).children("td").eq(31).text()
                            var alyciclo = largo.eq(i-1).children("td").eq(32).text()
                            var howard = largo.eq(i-1).children("td").eq(33).text()
                            var generico_1 = largo.eq(i-1).children("td").eq(34).text()
                            var generico_2 = largo.eq(i-1).children("td").eq(35).text()
                            var generico_3 = largo.eq(i-1).children("td").eq(36).text()
                            var generico_4 = largo.eq(i-1).children("td").eq(37).text()
                            var generico_5 = largo.eq(i-1).children("td").eq(38).text()
                            var generico_6 = largo.eq(i-1).children("td").eq(39).text()
                            var generico_7 = largo.eq(i-1).children("td").eq(40).text()
                            var generico_8 = largo.eq(i-1).children("td").eq(41).text()
                            var generico_9 = largo.eq(i-1).children("td").eq(42).text()
                            var generico_10 = largo.eq(i - 1).children("td").eq(43).text()
        										var generico_11 = largo.eq(i - 1).children("td").eq(44).text()
        										var generico_12 = largo.eq(i - 1).children("td").eq(45).text()
        										var generico_13 = largo.eq(i - 1).children("td").eq(46).text()
        										var generico_14 = largo.eq(i - 1).children("td").eq(47).text()
        										var generico_15 = largo.eq(i - 1).children("td").eq(48).text()
        										var generico_16 = largo.eq(i - 1).children("td").eq(49).text()
        										var generico_17 = largo.eq(i - 1).children("td").eq(50).text()
        										var generico_18 = largo.eq(i - 1).children("td").eq(51).text()
        										var generico_19 = largo.eq(i - 1).children("td").eq(52).text()
        										var generico_20 = largo.eq(i - 1).children("td").eq(53).text()
        										var generico_21 = largo.eq(i - 1).children("td").eq(54).text()
        										var generico_22 = largo.eq(i - 1).children("td").eq(55).text()
        										var generico_23 = largo.eq(i - 1).children("td").eq(56).text()
        										var generico_24 = largo.eq(i - 1).children("td").eq(57).text()
        										var generico_25 = largo.eq(i - 1).children("td").eq(58).text()
                            actualiza_linea(
              ...
              if(e.target.className =="material-icons bajar"){
                ...
                for (var i = posicionActual ; i < largob.length ; i++) {
                  ...
                  var recorrer=false;
                  var ph=largob.eq(i+1).children("td").eq(14).text();
                  console.log("ph :"+ph);
                       ...
                       if(ph==""){
                         ...
                         return;
                          ...
                          if(recorrer){
                            ...
                            var locacion = largob.eq(i+1).children("td").eq(3).text()
                            var articulo = largob.eq(i+1).children("td").eq(4).text()
                            var fecha = largob.eq(i+1).children("td").eq(5).text()
                            var lote = largob.eq(i+1).children("td").eq(6).text()
                            var referencia = largob.eq(i+1).children("td").eq(7).text()
                            var estado = largob.eq(i+1).children("td").eq(8).text()
                            var descripcion = largob.eq(i+1).children("td").eq(9).text()
                            var cliente = largob.eq(i+1).children("td").eq(10).text()
                            var nombre = largob.eq(i+1).children("td").eq(11).text()
                            var cantidad = largob.eq(i+1).children("td").eq(12).text()
                            var um = largob.eq(i+1).children("td").eq(13).text()
                            var phs = largob.eq(i+1).children("td").eq(14).text()
                            var brix = largob.eq(i+1).children("td").eq(15).text()
                            var cons5sec = largob.eq(i+1).children("td").eq(16).text()
                            var cons30sec = largob.eq(i+1).children("td").eq(17).text()
                            var acasc = largob.eq(i+1).children("td").eq(18).text()
                            var acidez = largob.eq(i+1).children("td").eq(19).text()
                            var bar = largob.eq(i+1).children("td").eq(20).text()
                            var color = largob.eq(i+1).children("td").eq(21).text()
                            var densidad = largob.eq(i+1).children("td").eq(22).text()
                            var pnegro = largob.eq(i+1).children("td").eq(23).text()
                            var patulina = largob.eq(i+1).children("td").eq(24).text()
                            var ramacidos = largob.eq(i+1).children("td").eq(25).text()
                            var hongos = largob.eq(i+1).children("td").eq(26).text()
                            var levadura = largob.eq(i+1).children("td").eq(27).text()
                            var ecoli = largob.eq(i+1).children("td").eq(28).text()
                            var coliformes = largob.eq(i+1).children("td").eq(29).text()
                            var hongosterm = largob.eq(i+1).children("td").eq(30).text()
                            var salmonela = largob.eq(i+1).children("td").eq(31).text()
                            var alyciclo = largob.eq(i+1).children("td").eq(32).text()
                            var howard = largob.eq(i+1).children("td").eq(33).text()
                            var generico_1 = largob.eq(i+1).children("td").eq(34).text()
                            var generico_2 = largob.eq(i+1).children("td").eq(35).text()
                            var generico_3 = largob.eq(i+1).children("td").eq(36).text()
                            var generico_4 = largob.eq(i+1).children("td").eq(37).text()
                            var generico_5 = largob.eq(i+1).children("td").eq(38).text()
                            var generico_6 = largob.eq(i+1).children("td").eq(39).text()
                            var generico_7 = largob.eq(i+1).children("td").eq(40).text()
                            var generico_8 = largob.eq(i+1).children("td").eq(41).text()
                            var generico_9 = largob.eq(i+1).children("td").eq(42).text()
                            var generico_10 = largob.eq(i + 1).children("td").eq(43).text()
        										var generico_11 = largob.eq(i + 1).children("td").eq(44).text()
        										var generico_12 = largob.eq(i + 1).children("td").eq(45).text()
        										var generico_13 = largob.eq(i + 1).children("td").eq(46).text()
        										var generico_14 = largob.eq(i + 1).children("td").eq(47).text()
        										var generico_15 = largob.eq(i + 1).children("td").eq(48).text()
        										var generico_16 = largob.eq(i + 1).children("td").eq(49).text()
        										var generico_17 = largob.eq(i + 1).children("td").eq(50).text()
        										var generico_18 = largob.eq(i + 1).children("td").eq(51).text()
        										var generico_19 = largob.eq(i + 1).children("td").eq(52).text()
        										var generico_20 = largob.eq(i + 1).children("td").eq(53).text()
        										var generico_21 = largob.eq(i + 1).children("td").eq(54).text()
        										var generico_22 = largob.eq(i + 1).children("td").eq(55).text()
        										var generico_23 = largob.eq(i + 1).children("td").eq(56).text()
        										var generico_24 = largob.eq(i + 1).children("td").eq(57).text()
        										var generico_25 = largob.eq(i + 1).children("td").eq(58).text()
                            actualiza_linea(
                              id, locacion, articulo, fecha, lote, referencia, estado, descripcion, cliente, nombre, cantidad, um, phs, brix, cons5sec, cons30sec, acasc, acidez, bar, color, densidad, pnegro, patulina, ramacidos, hongos, levadura, ecoli, coliformes, hongosterm, salmonela, alyciclo, howard, generico_1, generico_2, generico_3, generico_4, generico_5, generico_6, generico_7, generico_8, generico_9, generico_10, generico_11, generico_12, generico_13, generico_14, generico_15, generico_16, generico_17, generico_18, generico_19, generico_20, generico_21, generico_22, generico_23, generico_24, generico_25 );
                              for (var n = 0; n < db.analisis.length; n++) {
                                if(db.analisis[n].Id == id){
...
// console.log($('tr.jsgrid-row').children().next().next().next().next().next().next('.qad').text());
...
$('body').on('click', 'td', function(){
  ...
  // var id = $(this).parent('tr').children('td.id').text();
  var largo_td = $('tr').children('td.id').length;
  var ids = [];

  for (var i = 3; i < largo_td; i++) {
    var id = $('tr').eq(i).children('td.id').text();
    ids.push(id);
  }

  $.ajax({
    url: base_url+'analista/ana_analista_c/ingresadoUsuario',
    type: 'POST',
    dataType: 'json'
  })
  .done(function(data) {
    // console.log(data);
    console.log("success ingresadoUsuario");

    for (var i = 0; i < data.length; i++) {
      for (var j = 0; j < ids.length; j++) {
        if (data[i].an_id == ids[j]) {
          // console.log("OK "+data[i].an_id+ " "+ids[j]);
          console.log(j);
          $('tr').eq(j).css('background-color', 'red');
        }
      }
  ...
  .fail(function(data) {
    console.log(data);
    console.log("error ingresadoUsuario");
  })

  $('body').on('click', function() {
    var largo = $('td.esta_qad').length;
		var largo2 = $('td.ingresado_qad').length;
